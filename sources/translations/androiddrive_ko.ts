...
<context>
    ...
    <message>
        ...
        <translation>%1로 마운트됨</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>선택한 Android 기기의 내부 저장소가 들어 있는 드라이브와 선택한 기기에 있는 외부 SD 카드 (있는 경우) 각각의 드라이브를 마운트합니다.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>선택한 Android 기기에 해당하는 모든 드라이브를 마운트 해제합니다.&lt;br/&gt;&lt;br/&gt;이렇게 하면 드라이브만 마운트 해제되고 Android 기기 자체는 연결된 상태로 유지되므로 ADB 등을 통해 계속 액세스할 수 있습니다.</translation>
    </message>
    <message>
        <location filename="../devicelistwindow.cpp" line="167"/>
        <source>&amp;Mount all drives</source>
        <translation>모든 드라이브 마운트(&amp;M)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>선택한 드라이브를 마운트 해제합니다.&lt;br/&gt;&lt;br/&gt;이렇게 하면 드라이브만 마운트 해제되고 Android 기기 자체는 연결된 상태로 유지되므로 ADB 등을 통해 계속 액세스할 수 있습니다.</translation>
    </message>
    <message>
        <location filename="../devicelistwindow.cpp" line="177"/>
        <location filename="../devicelistwindow.hpp" line="85"/>
        <source>&amp;Mount drive</source>
        <translation>마운트 드라이브(&amp;M)</translation>
    </message>
    <message>
        ...
        <translation>선택한 내부 저장소나 외부 SD 카드가 들어 있는 드라이브를 마운트합니다.</translation>
    </message>
    <message>
        ...
        <translation>치명적인 오류: Android 기기를 나열할 수 없습니다.&lt;br/&gt;&lt;br/&gt;ADB가 코드 %1과 함께 종료되었습니다.</translation>
    </message>
    <message>
        ...
        <translation>기기 %1이(가) 오프라인 상태입니다.&lt;br/&gt;&lt;br/&gt;장치의 잠금을 해제한 다음 플러그를 뽑았다가 다시 꽂아보세요.&lt;br/&gt;&lt;br/&gt;이 오류가 지속되면 &lt;a href=&quot;%2&quot;&gt;여기&lt;/a&gt;에서 해결책을 찾을 수 있습니다(여기에 언급된 모든 adb 명령은 &lt;code&gt;cd &quot;%3&quot;&lt;/code&gt;을 실행한 후 명령 프롬프트에서 실행할 수 있습니다).</translation>
    </message>
    <message>
        ...
        <translation>기기 %1은(는) 승인되지 않았습니다.&lt;br/&gt;&lt;br/&gt;기기 잠금을 해제해 보세요. 이 컴퓨터에서 휴대폰 데이터에 접근하도록 허용할지 묻는 대화 상자가 나타나면 &quot;허용&quot;을 탭하세요. 대화 상자가 나타나지 않으면 &lt;a href=&quot;%2&quot;&gt;여기&lt;/a&gt;에 설명된 대로 USB 디버깅을 비활성화했다가 다시 활성화하세요.&lt;br/&gt;&lt;br/&gt;그래도 작동하지 않으면 기기의 플러그를 뽑았다가 다시 꽂아 보세요.</translation>
    </message>
    <message>
        <location filename="../devicelistwindow.cpp" line="253"/>
        <source>Could not create a drive with the given drive letter.</source>
        <translation>주어진 드라이브 문자로 드라이브를 만들 수 없습니다.</translation>
    </message>
    <message>
        ...
        <translation>Dokan이 설치되지 않은 것 같습니다.&lt;br/&gt;&lt;br/&gt;지금 설치하시겠습니까?</translation>
    </message>
    <message>
        <location filename="../devicelistwindow.cpp" line="264"/>
        <source>Could not start the driver.</source>
        <translation>드라이버를 시작할 수 없습니다.</translation>
    </message>
    <message>
        ...
        <translation>드라이브 문자를 할당할 수 없습니다.&lt;br/&gt;&lt;br/&gt;장치 설정에서 드라이브 문자를 사용 가능한 드라이브 문자로 변경해 보세요.</translation>
    </message>
    <message>
        <location filename="../devicelistwindow.cpp" line="271"/>
        <source>Dokan version error.</source>
        <translation>Dokan 버전 오류입니다.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>드라이브 %1을 마운트할 수 없습니다: %2</translation>
    </message>
    <message>
        <location filename="../devicelistwindow.cpp" line="293"/>
        <source>ADB timed out.</source>
        <translation>ADB 시간이 초과되었습니다.</translation>
    </message>
    <message>
        ...
        <translation>ADB 프로세스에서 읽는 동안 오류가 발생했습니다.</translation>
    </message>
    <message>
        ...
        <translation>ADB 프로세스에 쓰는 동안 오류가 발생했습니다.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>선택한 Android 드라이브에 대해 기본 드라이브 문자를 선택할 수 있습니다.&lt;br/&gt;&lt;br/&gt;이 드라이브가 연결되었을 때 기본 드라이브 문자를 사용할 수 없는 경우 알파벳순으로 정렬된 다음 사용 가능한 드라이브 문자가 사용됩니다.&lt;br/&gt;&lt;br/&gt;이 드라이브가 연결된 동안 드라이브 문자를 변경하는 경우 변경 사항을 적용하려면 드라이브를 마운트 해제했다가 다시 마운트해야 합니다.</translation>
    </message>
    <message>
        <location filename="../settingswindow.cpp" line="35"/>
        <source>Drive &amp;letter</source>
        <translation>드라이브 문자(&amp;L)</translation>
    </message>
    <message>
        <location filename="../settingswindow.cpp" line="42"/>
        <source>Allows you to select a name for the selected Android drive.</source>
        <translation>선택한 Android 드라이브의 이름을 선택할 수 있습니다.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>이 확인란을 선택하면 선택한 드라이브가 컴퓨터에 연결될 때마다 자동으로 드라이브로 연결됩니다.&lt;br/&gt;&lt;br/&gt;그렇지 않으면 장치 &gt; 드라이브 마운트로 이동하여 수동으로 마운트해야 합니다.</translation>
    </message>
    <message>
        <location filename="../settingswindow.cpp" line="63"/>
        <source>These settings only affect the selected drive.</source>
        <translation>이러한 설정은 선택한 드라이브에만 영향을 미칩니다.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>탐색기에서 새로 연결된 드라이브 열기(&amp;E)</translation>
    </message>
    <message>
        ...
        <translation>이 확인란을 선택하면 AndroidDrive가 드라이브 연결을 마칠 때마다 Windows 탐색기에서 해당 드라이브를 엽니다.</translation>
    </message>
    <message>
        <location filename="../settingswindow.cpp" line="76"/>
        <source>&amp;Hide files beginning with a dot</source>
        <translation>점으로 시작하는 파일 숨기기(&amp;H)</translation>
    </message>
    <message>
        ...
        <translation>이 확인란을 선택하면 점으로 시작하는 파일은 숨겨진 파일로 처리되며 Windows 탐색기의 &quot;숨김 파일 표시&quot; 옵션이 활성화된 경우에만 Windows 탐색기에서 표시됩니다.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>AndroidDrive GUI가 어떤 언어로 표시될지 선택할 수 있습니다.&lt;br/&gt;&lt;br/&gt;&quot;시스템 언어 사용&quot;을 선택했지만 AndroidDrive를 시스템 언어로 사용할 수 없는 경우 영어가 사용됩니다.&lt;br/&gt;&lt;br/&gt;이 설정은 실제 드라이브 작동 방식에는 영향을 미치지 않습니다.&lt;br/&gt;&lt;br/&gt;이 변경 사항을 적용하려면 AndroidDrive를 다시 시작해야 합니다.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>AndroidDrive는 귀하의 시스템 언어로 제공되지 않는 것 같습니다.&lt;br/&gt;&lt;br/&gt;&lt;a %1&gt;여기를 클릭&lt;/a&gt;하시면 번역에 도움을 주실 수 있습니다.</translation>
    </message>
    <message>
        <location filename="../settingswindow.cpp" line="104"/>
        <source>These settings affect all drives connected with AndroidDrive.</source>
        <translation>이러한 설정은 AndroidDrive에 연결된 모든 드라이브에 영향을 미칩니다.</translation>
    </message>
    <message>
